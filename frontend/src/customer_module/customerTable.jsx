        ...
        <AlertDialogContent className="bg-white sm:max-w-2xl">
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              <label className="text-right text-sm font-medium text-gray-700 required-field">Name</label>
              <input
                name="vendor_name"
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <label className="text-right text-sm font-medium text-gray-700 required-field">Contact Person</label>
              <input
                name="contact_person"
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <label className="text-right text-sm font-medium text-gray-700 required-field">Phone</label>
              <input
                name="phone_number"
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <label className="text-right text-sm font-medium text-gray-700 required-field">Address</label>
              <textarea
                name="address"
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <select
                name="status_id"
                value={editFormData.status_id || 1}
                onChange={handleEditFormChange}
                className="col-span-3 p-2 border rounded-md"
              >
          ...
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={handleEditSubmit}>Save Changes</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </div>
